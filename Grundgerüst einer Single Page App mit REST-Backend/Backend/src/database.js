...
/**
 * Singleton-Klasse zum Zugriff auf das MongoDB-Datenbankobjekt.
 * Es wird einfach das Singleton-Objekt dieser Klasse importiert und das Attribut
 * `mongodb` oder `database` ausgelesen.
 */
class DatabaseFactory {
    /**
     * Ersatz für den Konstruktor, damit aus dem Hauptprogramm heraus die
     * Verbindungs-URL der MongoDB übergeben werden kann, wodurch eine Verbindung hergestellt wird.
     *
    ...
    /**
     * Hilfsmethode zum Anlegen von Demodaten. Diese Daten dienen als Beispiel und
     * sind von uns frei konstruiert worden, um gleich ein paar Daten (fünf Einträge) anzeigen zu lassen.
     * (Man würde regulär in einer Produktivanwendung nicht so vorgehen)
     */
